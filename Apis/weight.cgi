...
my $APP_NAME = "weight";
my $APP_NAME_TITLE = $SiteName."Weight log";
    my $shop = 'cs';
    my $homeviewname ;
    my $home_view; 
    my $BASIC_DATA_VIEW; 
...
my %feeds =
    (
      0.50 => '65-70 or 115-120',
      1.00 => '60-65 or 110-115',
      1.50 => '55-60 or 105-110',
      2.00 => '50-55 ot 100-105',
      2.50 => '45-50 or 95-100',
      3.00 => '40-45 or 90-95',
      3.50 => '35-40 or 85-90',
      4.00 => '30-35 or 80-85',
      4.50 => '75-80',
...
my %BASIC_INPUT_WIDGET_DEFINITIONS = (
    ...
    feeds => [
        -DISPLAY_NAME => 'Number of feeds',
        -TYPE         => 'popup_menu',
        -NAME         => 'feeds',
        -VALUES       => [sort {$a <=> $b} keys %feeds],
		  -LABELS       => \%feeds,
        -INPUT_CELL_COLSPAN => 3,
    ],
...
my @ACTION_HANDLER_ACTION_PARAMS = (
    ...
    -DEFAULT_SORT_FIELD1                    => 'queen_code',
    -DEFAULT_SORT_FIELD2                    => '',
