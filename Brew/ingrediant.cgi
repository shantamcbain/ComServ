...
use SiteSetup;
  ...
  my $SetupVariables  = new SiteSetup($UseModPerl, $SiteName);
    $home_view             = 'ingrediantsView'; 
    $homeviewname          = 'ingrediantsView';
...
my @ITEM_DATASOURCE_FIELD_NAMES = qw(
        record_id
        status
        sitename
        item_code
...
my	@ITEM_DATASOURCE_CONFIG_PARAMS = (
	        -TYPE         => 'DBI',
	        -DBI_DSN      => $DBI_DSN,
	        -TABLE        => 'item_tb',
	        -USERNAME     => $AUTH_MSQL_USER_NAME,
	        -PASSWORD     => $MySQLPW,
	        -FIELD_NAMES  => \@ITEM_DATASOURCE_FIELD_NAMES,
...
my @RECIPE_DATASOURCE_FIELD_NAMES = qw(
        category
        record_id
        sitename
        recipe_code
...
my	@RECIPE_DATASOURCE_CONFIG_PARAMS = (
	        ...
	        -USERNAME     => $AUTH_MSQL_USER_NAME,
	        -PASSWORD     => $MySQLPW,
	        -FIELD_NAMES  => \@RECIPE_DATASOURCE_FIELD_NAMES,
	        -KEY_FIELDS   => ['username'],
	        -FIELD_TYPES  => {
	            record_id        => 'Autoincrement'
	        },
...
my @DATASOURCE_CONFIG_PARAMS = (
    ...
    -RECIPE_DATASOURCE_CONFIG_PARAMS    => \@RECIPE_DATASOURCE_CONFIG_PARAMS,
    -DROPLIST_DATASOURCE_CONFIG_PARAMS  => \@DROPLIST_DATASOURCE_CONFIG_PARAMS,
    -ITEM_DATASOURCE_CONFIG_PARAMS   => \@ITEM_DATASOURCE_CONFIG_PARAMS,
...
my @ACTION_HANDLER_LIST = 
    qw(
       Brew::PopulateInputWidgetDefinitionListWithRecipeCodeWidgetAction
       Brew::PopulateInputWidgetDefinitionListWithItemCodeWidgetAction    
