#!/usr/bin/perl -wT
# 	$Id: time_log.cgi,v 1.5 2017/06/03 19:36:17 shanta Exp shanta $	
...
my $APP_NAME = "time_log";

my $APP_NAME_TITLE = "Time Log";
my $SiteName =  $CGI->param('site');
my $site_update;
    my $SITE_DISPLAY_NAME = 'None Defined for this site.';
    my $last_update  = 'June 03, 2014';
 ...
 batchnumber   => [
   ...
   sitename => [
    ...
    time_code => [
                 ...
                 -TYPE         => 'popup_menu',
                 -NAME         => 'time_code',
                 -VALUES       => [sort {$a cmp $b} keys %time_code],
		           -LABELS       => \%time_code,
...
my @VALID_VIEWS = 
    qw(
       ...
       ECFCSSView
       ApisCSSView
       CSPSCSSView 	2018-11-29 18:49:50 	0 		Brew_admin 	
       CSCCSSView
       ...
       PowerSearchFormView
       OptionsView 	2018-11-29 18:49:50 	0 		Brew_admin 	
       LogoffView
       ToDoHomeView
      );
