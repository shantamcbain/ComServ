...
######################################################################
    ...
    my $APP_NAME = "log"; 
    my $last_update  = 'November 20, 2014';
    my $site_update;
    ...
    -FIELD_MAPPINGS =>
      {
       ...
       site_name                => 'Owner',
       batchnumber                 => 'batchnumber If not in list select other and place your suggestion in comments',
       subject                  => 'Subject batchnumber  If not in list select other and place your suggestion in comments',
       share    	      	=> 'Share level',
...
my @MODIFY_FORM_DHM_CONFIG_PARAMS = (
    ...
    -FIELD_MAPPINGS => {
       site_name                => 'Owner',
       batchnumber                 => 'batchnumber<br> If not in list select other and place your suggestion in comments',
       subject                  => 'Subject batchnumber <br> If not in list select other and place your suggestion in comments',
       share    	      	=> 'Share level',
       name                     => 'Name of resource',
       description              => 'Description of resource',
       url                      => 'URL',
