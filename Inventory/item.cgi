...
#                          SITE SETUP                             #
######################################################################
my $version = 'Version 0.02';
my $last_update = 'October 24, 2014';
my $APP_NAME = "Item"; 
my $APP_NAME_TITLE = "Item tracking system";
...
#Mail settings
   ...
   $TableName             = 'item_tb';
    my $frame =0;
    my @VALID_VIEWS = $SetupVariables->{-VALID_VIEWS};
...
use ECFSetup;
  my $SetupVariablesECF    = new  ECFSetup($UseModPerl);
    ...
    $homeviewname          = 'BasicDataView'||$SetupVariablesECF->{-HOME_VIEW_NAME};
    $home_view             = 'BasicDataView'||$SetupVariablesECF->{-HOME_VIEW};
#Mail settings
...
my %BASIC_INPUT_WIDGET_DEFINITIONS = 
    ...
    item_code => [
        -DISPLAY_NAME => 'Item Code no spaces',
        -TYPE         => 'textfield',
        -NAME         => 'item_code',
        -SIZE         => 30,
        -MAXLENGTH    => 80
    ...
    item_name => [
     ...
     number => [
        -DISPLAY_NAME => 'number needed of item',
        -TYPE         => 'textfield',
        -NAME         => 'number',
        -VALUE        => 1,
        -SIZE         => 30,
   ...
   weight => [
        -DISPLAY_NAME => 'Weight of item in kg',
        -TYPE         => 'textfield',
        -NAME         => 'weight',
        -SIZE         => 30,
        -MAXLENGTH    => 80
   ...
   price => [
        -DISPLAY_NAME => 'Price of item in CD',
        -TYPE         => 'textfield',
        -NAME         => 'price',
        -SIZE         => 30,
        -MAXLENGTH    => 80
     ...
     is_container => [
                 ...
                 -TYPE         => 'popup_menu',
                 -NAME         => 'is_container',
                 -VALUES       => [sort {$a <=> $b} keys %is_container],
		 -LABELS       => \%is_container,
                 -INPUT_CELL_COLSPAN => 3,
                ],
  );
...
my @ACTION_HANDLER_LIST = 
    qw(
       ...
       Inventory::HandleSearchForItemInContainerAction
       Default::PopulateInputWidgetDefinitionListWithLocationWidgetAction
       Default::DisplayDetailsRecordViewAction
