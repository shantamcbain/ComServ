...
my @VIEWS_SEARCH_PATH = 
    qw(../Modules/Extropia/View/Todo ../Modules/Extropia/View/Default);

my @TEMPLATES_SEARCH_PATH = qw(
  ../HTMLTemplates/Apis
  ../HTMLTemplates/Brew
...
#Mail settings
    ...
    my $ANI_FAVICON;
    my $FAVICON_TYPE;
    my $last_update = 'September 19, 2018';
...
my $APP = new Extropia::Core::App::DBApp(
    ...
    -VIEW_DISPLAY_PARAMS          => \@VIEW_DISPLAY_PARAMS
             ...
             $CGI->script_name()../Modules/Extropia/View/Default);
