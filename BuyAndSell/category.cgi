#!/usr/bin/perl -wT
# 	$Id: catagory.cgi,v 0.13 2004/01/25 03:48:50 shanta Exp $	
...
my $APP_NAME = "category";
my $MOD_NAME = "category";
my $site_update;
my $SiteName =  $CGI->param('site') || "CSC";
my $APP_NAME_TITLE = $SiteName." Category editor";
my $AppVer = "ver 1.01, Sunday, 04 March 2007";
...
#Mail settings
    ...
    my $DEFAULT_CHARSET;
    my $last_update = '15 October 2011';
...
my %BASIC_INPUT_WIDGET_DEFINITIONS = (
    ...
    category => [
        -DISPLAY_NAME => 'Category Stored no spaces',
        -TYPE         => 'textfield',
        -NAME         => 'category',
        -SIZE         => 30,
        -MAXLENGTH    => 80
...
my	@CLIENT_DATASOURCE_CONFIG_PARAMS = (
	        -TYPE         => 'DBI',
	        -DBI_DSN      => $DBI_DSN||'mysql:host=localhost;database=forager',
	        -TABLE        => 'csc_client_tb',
	        -USERNAME     => $AUTH_MSQL_USER_NAME,
	        -PASSWORD     => $MySQLPW,
...
$site_update,
    -LOGOFF_VIEW_NAME                       =>   	 -APP_VER                                => $AppVer,
    -LOCAL_IP                               => $LocalIp,
