...
my $FAVICON_TYPE;
    ...
    my $last_update = 'Feb 10, 2023';
my $site_update;
my $Affiliate = 001;
my $client_tb = 'customersettingstb';
my $HasMembers = 0;
...
my @ACTION_HANDLER_ACTION_PARAMS = (
    ...
    -SORT_FIELD1                            => $CGI->param('sort_field1') || 'DomainName',
