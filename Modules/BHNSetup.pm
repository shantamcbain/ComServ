...
my $self = {
	   ...
	   -MAIL_FROM              => 'danieldayneswood@gmail.com',
	   -MAIL_TO                => 'shanta@beemaster.ca, danieldayneswood@gmail.com, daneldaysneswood@beeherenow.beemaster.ca',
       ...
       -HTTP_HEADER_DESCRIPTION => "Bee Here now  application created 
