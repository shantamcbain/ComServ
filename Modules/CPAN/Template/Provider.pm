...
#----------------------------------------------------------------------------
#
# $Id: Provider.pm,v 1.10 2001/09/09 15:23:51 gunther Exp $
#
#============================================================================
...
# _refresh(\@slot)
#
# Private method called to mark a cache slot as most recently used.  A
# reference to the slot array should be passed by parameter.  The slot
# is relocated to the head of the linked list.  If the file from which
# the data was loaded has been updated since it was compiled, then it
# is re-loaded from disk and re-compiled.
#------------------------------------------------------------------------
