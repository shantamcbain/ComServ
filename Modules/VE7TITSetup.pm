...
my $self = {
	    ...
	    -MAIL_FROM         => 've7tit@weaverbeck.com',
	    -MAIL_TO           => 've7tit@weaverbeck.com',
	    ...
	    -MAIL_REPLYTO      => 'vettit@shanta.org',
        ...
        -HTTP_HEADER_DESCRIPTION => "Shanta McBain's Ham radio site. Gateway to many applications",
        -HTTP_HEADER_KEYWORDS    => "health, herbs, herbalogy, ENCY, apis theropys, homiopothy, alternate healing,
        integrated health management, nutrition, CSPS, Brewing, Beer , wine, mead, organic farming, ham radio, Shanta McBain, shanta, McBain, geniology    ",
        -SITE_DISPLAY_NAME              => 'VE7TIT Ham Shack',
	    -VALID_FORUMS                   => (
