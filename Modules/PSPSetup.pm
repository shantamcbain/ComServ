...
my $self = {-HOME_VIEW_NAME    => 'HomeView',
	    -HOME_VIEW         => 'HomeView',
        -SITE_LAST_UPDATE  => 'March, 30 2020',
        -AUTH_TABLE        => 'psp_user_auth_tb',
       ...
       -HTTP_HEADER_DESCRIPTION => "Planting Seeds Project.  ",
       -HTTP_HEADER_KEYWORDS    => "Seeds, ",
	    -DATASOURCE_TYPE     => $datesourcetype,
 	    -ADDITIONALAUTHUSERNAMECOMMENTS => 'Please do not use spaces.',
       -SITE_DISPLAY_NAME => 'Planting Seeds Project application',
	    -GLOBAL_DATAFILES_DIRECTORY => "../../Datafiles",
	    -TEMPLATES_CACHE_DIRECTORY  => '/TemplatesCache',
	    -APP_DATAFILES_DIRECTORY => "../../Datafiles/PSP",
	    };
#	    -MySQLPW             => '!herbsRox!',
