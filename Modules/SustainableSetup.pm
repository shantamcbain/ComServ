package SustainableSetup;

# 	$Id: SustainableSetup.pm,v 1.1 2014/02/11 06:35:52 shanta Exp shanta $	
...
my $MySQLPW                      = '!herbsRox!';
my $AUTH_TABLE                   = 'sustainable_user_auth_tb';
...
my $self = {-HOME_VIEW_NAME                => 'HomeView',
            -SITE_LAST_UPDATE                   => 'Febuary 11, 2014',
	    -HOME_VIEW                          => 'PageView',
            -SITE_DISPLAY_NAME                  => 'Sustainable Farming',
	    ...
	    -DOCUMENT_ROOT_URL                  => '/',
            ...
            -HTTP_HEADER_DESCRIPTION            => "Sustainable Farming and Community.",
            -HTTP_HEADER_KEYWORDS               => "sustainable, farming, agriculture, purmaculture, aquaculture, beekeeping, herbs ",
	    ...
	    -MAIL_TO_USER                       => 'sustainable_user_list@shamanbotanicals.ca',
	    -MAIL_TO_DISCUSSION                 => 'sutainable_discoussion@shamanbotanicals.ca',
	    -MAIL_LIST_BCC                      => '',
	    -MAIL_TO_CLIENT                     => 'sustinable_client@shamanbotanicals.ca',
