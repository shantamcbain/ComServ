...
my $self = {-HOME_VIEW_NAME    => 'HomeView',
       ...
       -SITE_DISPLAY_NAME => 'Saddle Mountain Tenant site.',
	    -HOME_VIEW         => 'HomeView',
       ...
       -DEFAULT_CHARSET   => 'ISO-8859-1', 
	    ...
	    -APP_DATAFILES_DIRECTORY => "/Datafiles/SMT",
       ...
       -LINK_TARGET       => '_self',
	    -MAIL_FROM         => 'shanta@computersystemconsulting.ca',
	    -MAIL_TO           => 'csc@computersystemconsulting.ca',
	    -MAIL_TO_AMIN      => 'admin@usbm.ca',
	    -MAIL_TO_DISCUSSION=> 'smt_discussion@usbm.ca',
	    -MAIL_TO_USER      => 'smt_user_list@usbm.ca',
	    -MAIL_TO_CLIENT    => 'telmark_client@usbm.ca',
	    -MAIL_REPLYTO      => 'smta@computersystemconsulting.ca',
