#$Id: TrulyRandom.pm,v 1.1.1.1 2001/03/12 05:38:31 stas Exp $
...
package Extropia::Core::KeyGenerator::TrulyRandom;
...
# 0 length leaves it up to hash algorithm to define length
...
sub createKey {
    ...
    my $random_string = 
        $extra_element . time() . {} . truly_random_value() . 
                         rand() . $$ . $secret;
