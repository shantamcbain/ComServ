...
my $self = {            
       -SHOP              => 'apis',
       -SITE_LAST_UPDATE       => 'Feb 7, 2014',
       -SITE_DISPLAY_NAME          => 'Sustanable Agriculture',
       ...
       -HTTP_HEADER_DESCRIPTION => "Sustainable farming, Permaculture, orgaic farming.",
       -HTTP_HEADER_KEYWORDS    => "Organic Farmin, Bees, bees, bee breeding, bee keeping, honey, honey production, queens, bee queens, permaculture, grain, herbs, sustainable farming sustainable community",
	    -DATASOURCE_TYPE     => $datesourcetype,
       -DATA_TABLE          => 'ecf_order_table',
       -DATA_TABLE_BILL     => 'bill_order_table',
       -AUTH_TABLE          => 'sustainable_user_auth_tb',
