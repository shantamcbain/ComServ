...
use AikikaiSetup;
  ...
  #   $StoreUrl                = $SetupVariablesAikikai->{-STORE_URL};
     ...
     $home_view               = $SetupVariablesAikikai->{-HOME_VIEW_NAME};
...
use SkyeFarmSetup;
  my $UseModPerl = 1;
  my $SetupVariablesSkye   = new SkyeFarmSetup($UseModPerl);
     $HTTP_HEADER_KEYWORDS    = $SetupVariablesSkye->{-HTTP_HEADER_KEYWORDS};
     $HTTP_HEADER_PARAMS      = $SetupVariablesSkye->{-HTTP_HEADER_PARAMS};
     $HTTP_HEADER_DESCRIPTION = $SetupVariablesSkye->{-HTTP_HEADER_DESCRIPTION};
     $CSS_VIEW_NAME           = $SetupVariablesSkye->{-CSS_VIEW_NAME};
     $AUTH_TABLE              = $SetupVariablesSkye->{-AUTH_TABLE};
     $app_logo                = $SetupVariablesSkye->{-APP_LOGO};
     $app_logo_height         = $SetupVariablesSkye->{-APP_LOGO_HEIGHT};
     $app_logo_width          = $SetupVariablesSkye->{-APP_LOGO_WIDTH};
     $app_logo_alt            = $SetupVariablesSkye->{-APP_LOGO_ALT};
     $mail_from               = $SetupVariablesSkye->{-MAIL_FROM};
     $mail_to                 = $SetupVariablesSkye->{-MAIL_TO};
     $mail_replyto            = $SetupVariablesSkye->{-MAIL_REPLYTO};
     $homeviewname            = $SetupVariablesSkye->{-HOME_VIEW_NAME};
     $home_view               = $SetupVariablesSkye->{-HOME_VIEW};
     $CSS_VIEW_URL            = $SetupVariablesSkye->{-CSS_VIEW_NAME};
     $APP_NAME_TITLE          = "Skye Farms";
     $APP_DATAFILES_DIRECTORY = $GLOBAL_DATAFILES_DIRECTORY.'/Skye'; 
     $SITE_DISPLAY_NAME       = $SetupVariablesSkye->{-SITE_DISPLAY_NAME};
     $last_update             = $SetupVariablesSkye->{-LAST_UPDATE};
    $site_update              = $SetupVariablesSkye->{-SITE_LAST_UPDATE};
    $shop                     = $SetupVariablesSkye->{-SHOP};
}
