...
use SiteSetup;
  ...
  my $SetupVariables  = new SiteSetup($UseModPerl);
    ...
    $home_view               = $SetupVariables->{-HOME_VIEW_NAME};
...
use BazaarSetup;
  my $SetupVariablesBazaar   = new BazaarSetup($UseModPerl);
     ...
     $home_view               = $SetupVariablesBazaar->{-HOME_VIEW_NAME};
...
use SBSetup;
  my $SetupVariablesSB   = new SBSetup($UseModPerl);
     ...
     $home_view               = $SetupVariablesSB->{-HOME_VIEW_NAME};
...
use TemplateSetup;
  my $SetupVariablesTemplate   = new TemplateSetup($UseModPerl);
     ...
     $home_view            = $SetupVariablesTemplate->{-HOME_VIEW_NAME};
...
use GrindrodSetup;
  my $SetupVariablesUrbanFarming   = new GrindrodSetup($UseModPerl);
     ...
     $home_view            = $SetupVariablesUrbanFarming->{-HOME_VIEW_NAME};
...
#    -SORT_DIRECTION                         => $CGI->param('sort_direction') || 'ASEN',
    ...
    -PAGE_NAME                               => $CGI->param('page')||'HomeView',
    -NEWS_TB                                => $NEWS_TB,
