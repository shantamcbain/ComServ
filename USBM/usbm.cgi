...
my $APP_NAME = "sb";
my $APP_NAME_TITLE = "USBM";

my $home_view        = 'USBMHomeView'; 
...
my $mail_to          = 'usbmadmin@forager.com';
my $mail_replyto     = 'usbmadmin@forager.com';
my $ColorForEvenRows = '#009933';
my $ColorForOddRows  = '#0CE684';
my $CSS_VIEW_NAME    = "CSSView";
my $app_logo         = '';
my $app_logo_height  = '70';
my $app_logo_width   = '158';
my $logo_alt         = 'USBM Logo';
