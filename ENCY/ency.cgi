#!/usr/bin/perl -wT 
# 	$Id: ency.cgi,v 1.7 2002/10/11 22:40:29 shanta Exp shanta $	
...
my $APP_NAME = "ency"; 
    ...
    my $site_update= 'Febuary 17, 2006';

my $APP_NAME_TITLE = "Encyclopedia of Biological Life";
    my $homeviewname         ;
    my $home_view            ;
    my $BASIC_DATA_VIEW      ;
    my $page_top_view        ;
...
my @ACTION_HANDLER_ACTION_PARAMS = (
    ...
    -BASIC_DATA_VIEW_NAME                   => 'ENCYHomeView',
