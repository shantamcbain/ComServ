package Default::PopulateInputWidgetDefinitionListWithClientWidgetAction;
...
sub execute {
    ...
    $cgi->param(
        -NAME  => 'raw_search', 
        -VALUE => "status=='active' AND sitename=='$params->{-SITE_NAME}' AND app_name == '$params->{-APP_NAME}'AND list_name=='client'
 "
    );   
...
#        -LABELS       => \@labels
    ...
    $$input_widget_definitions{'owner'} = \@project_code_widget;
