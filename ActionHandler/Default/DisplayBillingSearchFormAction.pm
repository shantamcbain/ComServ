package Default::DisplayBillingSearchFormAction;
...
sub execute {
    ...
    if (defined($cgi->param('display_billing_search_form'))) {
...
#        }
        ...
        $app->setNextViewToDisplay(
            -VIEW_NAME => $params->{-BILLING_SEARCH_VIEW_NAME}
        );
