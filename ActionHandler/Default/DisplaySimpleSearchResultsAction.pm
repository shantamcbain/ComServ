package Default::DisplaySimpleSearchResultsAction;
        ...
        if ($datasource_config_params) {
            my ($ra_records,$total_records) = $app->loadData
                (
                 ...
                 -LAST_RECORD_RETRIEVED       => $params->{-LAST_RECORD_ON_PAGE},
                 -SIMPLE_SEARCH_STRING        => $cgi->param('simple_search_string') || $params->{-SIMPLE_SEARCH_STRING},
