package Default::DisplayDeleteRecordConfirmationAction;
...
sub execute {
    ...
    my ($params) = _rearrangeAsHash([
        ...
        -DELETE_RECORD_CONFIRMATION_VIEW_NAME,
        -ENABLE_SORTING_FLAG,
        -KEY_FIELD,
        -LAST_RECORD_ON_PAGE,
        ...
        -DISPLAY_CONFIRMATION_ON_DELETE_FLAG,
    ...
    if (defined($cgi->param('display_delete_record_confirmation'))
        and $params->{-DISPLAY_CONFIRMATION_ON_DELETE_FLAG}) {
        ...
        $app->setNextViewToDisplay(
            -VIEW_NAME => $params->{-DELETE_RECORD_CONFIRMATION_VIEW_NAME}
        );
        ...
        if ($datasource_config_params) {
            ...
            (
             -ACTION_HANDLER_PLUGINS => $params->{-ACTION_HANDLER_PLUGINS},
             -CATEGORY               => '-handleIncomingData_BEGIN',
            );
