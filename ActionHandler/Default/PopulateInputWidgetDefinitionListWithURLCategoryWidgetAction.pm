package Default::PopulateInputWidgetDefinitionListWithURLCatagoryWidgetAction;
...
sub execute {
    ...
    $cgi->param(
        -NAME  => 'raw_search', 
        -VALUE => "status=='active' AND sitename=='$params->{-SITE_NAME}' AND app_name == '$params->{-APP_NAME}'"
    );   
