package ENCY::PopulateInputWidgetDefinitionListWithURLCategoryWidgetAction;
# 	$Id: PopulateInputWidgetDefinitionListWithURLCategoryWidgetAction.pm,v 1.1.1.1 2005/06/18 20:39:32 root Exp $	
...
sub execute {
    ...
    my @config_params = _rearrange([
        -CATEGORY_DATASOURCE_CONFIG_PARAMS
            ],
            [
        -CATEGORY_DATASOURCE_CONFIG_PARAMS
            ],
