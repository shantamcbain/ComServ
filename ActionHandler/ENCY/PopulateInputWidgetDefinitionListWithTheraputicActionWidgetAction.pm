package ENCY::PopulateInputWidgetDefinitionListWithTheraputicActionWidgetAction;


# 	$Id: PopulateInputWidgetDefinitionListWithTheraputicActionWidgetAction.pm,v 1.1.1.1 2005/06/18 20:39:32 root Exp $	
...
sub execute {
    ...
    $cgi->param(
        -NAME  => 'raw_search', 
        -VALUE => " list_category =='therapeutic_action'"
    );   

    my @config_params = _rearrange([
        -GLOSS_DATASOURCE_CONFIG_PARAMS
            ],
            [
        -GLOSS_DATASOURCE_CONFIG_PARAMS
            ],
...
#        -LABELS       => \@labels
    ...
    $$input_widget_definitions{'therapeutic_action'} = \@project_code_widget;
