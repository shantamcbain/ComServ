package ENCY::PopulateInputWidgetDefinitionListWithURLSubjectWidgetAction;
# 	$Id: PopulateInputWidgetDefinitionListWithURLSubjectWidgetAction.pm,v 1.1.1.1 2005/06/18 20:39:32 root Exp $	
...
sub execute {
    ...
    $cgi->param(
        -NAME  => 'raw_search',
        -VALUE => "status=='active' AND client_name='ENCY'"
    );   

    my @config_params = _rearrange([
        -SUBJECT_DATASOURCE_CONFIG_PARAMS
            ],
            [
        -SUBJECT_DATASOURCE_CONFIG_PARAMS
            ],
...
#<a href=\'http://computersystemconsulting.ca/cgi-bin/CSC/csc_url_sub.cgi?display_add_form=on\'> ADD</font></a>
    ...
    $$input_widget_definitions{'subject'} = \@project_code_widget;
