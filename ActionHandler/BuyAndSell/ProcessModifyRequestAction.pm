package BuyAndSell::ProcessModifyRequestAction;
...
# Sybase : 
 ...
 $body = $body."Click here to Reply ".$params->{-DOCUMENT_ROOT_URL2}.$params->{-SCRIPT_NAME2}."?display_add_form=on&record_id=".$cgi->param('record_id')."&parent_id=".$cgi->param('parent_id')."&thread_id=".$cgi->param('thread_id')."&site=".$params->{'-SITE_NAME'}."   ";
