package Expense::ExpenseSearchMyRecordsByExpenseType;
...
sub execute {
    ...
    if (defined($cgi->param('view_by_expense_type'))) {
        ...
        my $expense_type = $cgi->param('expense_type');

        $cgi->param(
            -NAME  => 'raw_search',
            -VALUE => "username_of_poster='$username' AND expense_type == '$expense_type'"
        );
