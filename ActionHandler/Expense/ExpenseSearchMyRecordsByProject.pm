package Expense::ExpenseSearchMyRecordsByProject;
...
sub execute {
    ...
    if (defined($cgi->param('view_by_project'))) {
        ...
        my $project_code = $cgi->param('project_code');
        $cgi->param(
            -NAME  => 'raw_search',
            -VALUE => "username_of_poster='$username' AND project_code == '$project_code'"
        );
