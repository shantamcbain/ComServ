package BugTracker::PopulateInputWidgetDefinitionListWithDevelopersWidgetAction;
...
sub execute {
    ...
    $$input_widget_definitions{'developer'} = \@developer_widget;
