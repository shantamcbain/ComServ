package CSC::DisplaySideBarViewAction;
...
sub execute {
    ...
    if (defined($cgi->param('display_sidebar_view')) ||
...
my  $SortField2= $cgi->param('SortField2')||'due_date';
my  $SortField1= $cgi->param('SortField1')||'priority';
