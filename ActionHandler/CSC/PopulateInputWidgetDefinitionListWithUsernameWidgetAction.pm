package CSC::PopulateInputWidgetDefinitionListWithUsernameWidgetAction;
...
sub execute {
    ...
    my $UserName = $params->{-KEY => 'username'};
    $cgi->param(
        -NAME  => 'raw_search',
        -VALUE => ''
    );  
...
#define tb to pick up info from
 ...
 #   my $datasource_config_params = shift @DATASOURCE_CONFIG_PARAMS;
    ...
    my $ra_records = $app->loadData((
        ...
        -SORT_FIELD1                 => 'username',
        -SORT_FIELD2                 => '',
        -MAX_RECORDS_PER_PAGE        => '5000'|$params->{-MAX_RECORDS_PER_PAGE},
...
#        -REQUIRE_MATCHING_GROUP_FOR_SEARCHING_FLAG => $params->{-REQUIRE_MATCHING_GROUP_FOR_SEARCHING_FLAG}
    ...
    $$input_widget_definitions{'username'} = \@project_code_widget;
