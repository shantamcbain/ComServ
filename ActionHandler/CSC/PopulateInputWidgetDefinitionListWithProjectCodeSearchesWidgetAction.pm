package BugTracker::PopulateInputWidgetDefinitionListWithProjectCodeWidgetAction;
...
#    my $datasource_config_params = shift (@config_params);
    ...
    my $ra_records = $app->loadData((
        ...
        -MAX_RECORDS_PER_PAGE        => 250||$params->{-MAX_RECORDS_PER_PAGE},
