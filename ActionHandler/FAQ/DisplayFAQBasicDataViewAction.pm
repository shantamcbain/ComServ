package FAQ::DisplayFAQBasicDataViewAction;
...
sub execute {
    ...
    my $rms     = $params->{-REQUIRE_MATCHING_SITE_FOR_SEARCHING_FLAG};
        ...
        if ($datasource_config_params) {
            ...
            if ($total_records == 1 && ($cgi->param('display_simple_search_results') ||
                ...
                $app->setNextViewToDisplay(
                   -VIEW_NAME => $params->{'DetailsRecordView'}
               );
            }
