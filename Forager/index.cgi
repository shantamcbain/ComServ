...
my $APP_NAME = "Forager"; 
my $SiteName =  $CGI->param('site') || "Forager";
my $APP_NAME_TITLE = "Forager";
    my $homeviewname ;
    my $home_view; 
    my $BASIC_DATA_VIEW; 
    my $page_top_view;
...
#Mail settings  
    ...
    $mail_from             = 'foragercgi@forager.com'; 
    $mail_to               = 'foragerwebmaster@forager.com';
...
#Mail settings
 ...
 elsif ($SiteName eq "Weaver") {
use WBSetup;
  my $SetupVariablesWeaver    = new  WeaverSetup($UseModPerl);
    $CSS_VIEW_NAME           = $SetupVariablesWeaver->{-CSS_VIEW_NAME};
    $AUTH_TABLE              = $SetupVariablesWeaver->{-AUTH_TABLE};
    $app_logo                = $SetupVariablesWeaver->{-APP_LOGO};
    $app_logo_height         = $SetupVariablesWeaver->{-APP_LOGO_HEIGHT};
    $app_logo_width          = $SetupVariablesWeaver->{-APP_LOGO_WIDTH};
    $app_logo_alt            = $SetupVariablesWeaver->{-APP_LOGO_ALT};
    $APP_NAME_TITLE          = "Base";
    $homeviewname            = $SetupVariablesWeaver->{-HOME_VIEW_NAME};
    $home_view               = $SetupVariablesWeaver->{-HOME_VIEW};
#Mail settings
    $mail_from               = $SetupVariablesWeaver->{-MAIL_FROM};
    $mail_to                 = $SetupVariablesWeaver->{-MAIL_TO};
    $mail_replyto            = $SetupVariablesWeaver->{-MAIL_REPLYTO};
    $HTTP_HEADER_PARAMS      = $SetupVariablesWeaver->{-HTTP_HEADER_PARAMS};
    $HTTP_HEADER_KEYWORDS    = $SetupVariablesWeaver->{-HTTP_HEADER_KEYWORDS};
    $HTTP_HEADER_DESCRIPTION = $SetupVariablesWeaver->{-HTTP_HEADER_DESCRIPTION};
    $CSS_VIEW_URL            = $SetupVariablesWeaver->{-CSS_VIEW_NAME};
    $SITE_DISPLAY_NAME       = $SetupVariablesWeaver->{-SITE_DISPLAY_NAME}||'test';
    $last_update             = $SetupVariablesWeaver->{-SITE_LAST_UPDATE}; 
 }
