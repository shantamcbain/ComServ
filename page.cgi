...
my @ACTION_HANDLER_ACTION_PARAMS = (
    ...
    -ALLOW_ADDITIONS_FLAG                   => $allow_add||1,
    -ALLOW_MODIFICATIONS_FLAG               => $allow_mod||1,
    -ALLOW_DELETIONS_FLAG                   => $allow_del||1,
